<?php
    ...
    while($i <= 1){
        ...
        // Tässä pitäisi olla event-driven architecture joka lähettää
        // käyttäjän selaimelle uuden vastauksen vain, jos jotakin
        // uutta on tapahtunut.
        // EDA ei myöskään lukitse palvelimen suoritusta samalla tavalla
        // kuin
        // while(sleep(1));
        ...
        $stmt->bind_param("ii", $chat_id, $latest_id);
        $stmt->execute();
        ...
        if(count($messages) > 0){
            echo "data: ". generateReceivedMessage($message['username'], 
            $message['content'],
    ...
    //3. Lopetetaan suoritus/katkaisemalla yhteys
